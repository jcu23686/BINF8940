...
#UNCOMMENT CODE FROM ASSEMBLIES THAT YOU ARE TRYING TO RUN QUAST ON
#assembly1
...
#assembly 26
#wget https://data.nist.gov/od/ds/ark:/88434/mds2-2578/assemblies-and-benchmarking_results/HG002-v0.11.tar.gz
#tar -xzvf HG002-v0.11.tar.gz
#quast HG002-v0.11/assembly/HG002-v0.11.mat.fa.gz
#quast HG002-v0.11/assembly/HG002-v0.11.pat.fa.gz
